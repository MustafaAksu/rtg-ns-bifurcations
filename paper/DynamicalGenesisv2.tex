...
\]
and the lifted $\SU(2)$ holonomy satisfies $\tfrac{1}{2}\Tr(H)\approx\cos(F_\triangle/2)\approx0.5$, verifying the trace--angle relation at the NS rung.
